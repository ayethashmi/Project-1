...
import com.maxdev.glitenetwork.signalstrenhtmeter.indicators.SSIndicator
import com.maxdev.glitenetwork.signalstrenhtmeter.indicators.SSNoIndicator
import com.maxdev.glitenetwork.speedmeter.Note
import com.maxdev.glitenetwork.speedmeter.OnPrintTickLabelListener
import com.maxdev.glitenetwork.speedmeter.Style
...
abstract class SSpedoMeter @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
) : SSGauge(context, attrs, defStyleAttr) {
     ...
     */
    var indicator: SSIndicator<*> = SSNoIndicator(context)
        set(indicator) {
...
//        indicator = NoIndicator(context)
    ...
    private fun initAttributeSet(context: Context, attrs: AttributeSet?) {
        ...
        if (ind != -1)
            setIndicator(SSIndicator.Indicators.values()[ind])
     ...
     */
    open fun setIndicator(indicator: SSIndicator.Indicators) {
        this.indicator = SSIndicator.createIndicator(context, this, indicator)
    }
