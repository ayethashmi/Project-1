...
import com.maxdev.glitenetwork.signalstrenhtmeter.indicators.SSSpindleIndicator
import com.maxdev.glitenetwork.speedmeter.Style
import com.maxdev.glitenetwork.speedmeter.getRoundAngle
 ...
 */
open class SSSPointerSpeedometer @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
) : SSpedoMeter(context, attrs, defStyleAttr) {
     ...
     */
    var centerCircleRadius = dpTOpx(9f)
    ...
    override fun defaultGaugeValues() {
        super.speedometerWidth = dpTOpx(8f)
    ...
    override fun defaultSpeedometerValues() {
        ...
        indicator = SSSpindleIndicator(context)
        indicator.apply {
            width = dpTOpx(13f)
